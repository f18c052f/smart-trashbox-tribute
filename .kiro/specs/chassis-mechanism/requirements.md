...
10. The chassis-mechanism shall 底の切り取り径を上流が公開する底の平面部径以下とし、⚠️ **外径との差として残る縁を、缶の重量を受ける座面として用いる**。⚠️ **縁は持ち上げ方向を止めない**——缶は上へ広がる円錐台であり、テーパーは持ち上げでは緩む側である。上方向の拘束は受入基準 5 の締結が担う
