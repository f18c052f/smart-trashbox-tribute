...
| 実機（移動体） | **ESP32 DevKit / JGB37-520 モータ / モータドライバ AE-TB67H450 は手元にある**（ドライバは 2026-08-24 に入手確認）。**Nexus 14145 ホイール / 18020 ハブは未着**（→ 機構の現物採寸は部分的にしか進められない） |
...
> ✅ **モータドライバ AE-TB67H450 は入手済**（2026-08-24 確認）。
